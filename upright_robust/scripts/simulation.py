...
class ReactiveBalancingController:
    def __init__(
        ...
        self.A_cart_weight = block_diag(a_cart_weight * np.eye(3), α_cart_weight * np.eye(3))
        self.P = block_diag(
    ...
    def solve(self, q, v, A_ew_w_cmd):
        ...
        return self._setup_and_solve_qp(G_e, V_ew_e, A_ew_e_cmd, δ, J, v)
